...
const MUSCLE_PATHS: MusclePath[] = [
  ...
  { key: "biceps", label: "Biceps", view: "front", d: "M18,74 Q14,86 16,98 Q22,94 26,82 Z" },
  { key: "biceps", label: "Biceps", view: "front", d: "M102,74 Q106,86 104,98 Q98,94 94,82 Z" },
  { key: "forearms", label: "Forearms", view: "front", d: "M14,100 Q10,116 12,128 Q18,124 22,108 Z" },
  { key: "forearms", label: "Forearms", view: "front", d: "M106,100 Q110,116 108,128 Q102,124 98,108 Z" },
  { key: "abs", label: "Abs", view: "front", d: "M46,98 Q60,102 74,98 Q76,118 74,132 Q60,136 46,132 Q44,118 46,98Z" },
  { key: "quads", label: "Quads", view: "front", d: "M44,138 Q52,140 56,160 Q52,176 46,180 Q38,168 40,150 Z" },
  ...
  { key: "back", label: "Mid Back", view: "back", d: "M44,72 Q60,76 76,72 Q76,96 60,100 Q44,96 44,72Z" },
  { key: "shoulders", label: "Rear Delts", view: "back", d: "M22,62 Q32,54 38,72 Q28,78 20,72 Z" },
  { key: "shoulders", label: "Rear Delts", view: "back", d: "M98,62 Q88,54 82,72 Q92,78 100,72 Z" },
  { key: "triceps", label: "Triceps", view: "back", d: "M18,74 Q14,86 16,98 Q22,94 26,82 Z" },
  { key: "triceps", label: "Triceps", view: "back", d: "M102,74 Q106,86 104,98 Q98,94 94,82 Z" },
  { key: "glutes", label: "Glutes", view: "back", d: "M44,104 Q52,106 58,124 Q50,130 42,122 Q40,112 44,104Z" },
  { key: "glutes", label: "Glutes", view: "back", d: "M76,104 Q68,106 62,124 Q70,130 78,122 Q80,112 76,104Z" },
  { key: "hamstrings", label: "Hamstrings", view: "back", d: "M44,128 Q50,132 54,154 Q48,170 42,168 Q38,152 40,136 Z" },
  { key: "hamstrings", label: "Hamstrings", view: "back", d: "M76,128 Q70,132 66,154 Q72,170 78,168 Q82,152 80,136 Z" },
  { key: "calves", label: "Calves", view: "back", d: "M42,172 Q46,184 44,200 Q40,202 38,192 Q36,180 40,172 Z" },
  { key: "calves", label: "Calves", view: "back", d: "M78,172 Q74,184 76,200 Q80,202 82,192 Q84,180 80,172 Z" },
];
